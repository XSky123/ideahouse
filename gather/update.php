<?php 
	...
	$sql="UPDATE gather_content SET type1='$type1' , type2='$type2' , site='$site' , addr='$addr' , is_recommend='$is_recommend' ,recommendation=NULL WHERE id='$id'";
	if($is_recommend){
		$recommendation=$_POST['recommendation'];
		$sql="UPDATE gather_content SET type1='$type1' , type2='$type2' , site='$site' , addr='$addr' , is_recommend='$is_recommend' , recommendation='$recommendation' WHERE id='$id' ";
	}
